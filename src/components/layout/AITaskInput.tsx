  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      for (const task of data) {
        ...
        await onCreateTask(task.title, task.content);
      }
        ...
        <div className="flex flex-col gap-3">
          <div className="flex gap-2">
            ...
            <Button
              ...
              className="px-6 py-2 bg-gray-700 text-white rounded-lg hover:bg-gray-800 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-2"
            />
          </div>
          {error && (
          ...
          <p className="text-center text-sm text-gray-400">
            Enter what you want to accomplish, and AI will break it down into step-by-step tasks
          </p>
        </div>
      </form>
    </div>
